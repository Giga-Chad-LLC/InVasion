...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fserver_2eproto[2];
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fserver_2eproto = {
  false, false, 246, descriptor_table_protodef_proto_2fserver_2eproto, "proto/server.proto", 
  &descriptor_table_proto_2fserver_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_proto_2fserver_2eproto::offsets,
  file_level_metadata_proto_2fserver_2eproto, file_level_enum_descriptors_proto_2fserver_2eproto, file_level_service_descriptors_proto_2fserver_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_proto_2fserver_2eproto_getter() {
  return &descriptor_table_proto_2fserver_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_proto_2fserver_2eproto(&descriptor_table_proto_2fserver_2eproto);
namespace helloworld {
